 ...
 * to the next).
 *
 * <p>Additionally, the {@link org.apache.hadoop.mapreduce.Mapper} interface is extended with two methods
 ...
 */
public class AppEngineReducer<KEYIN extends OutputKey, VALUEIN, KEYOUT, VALUEOUT> extends Reducer<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {
  ...
  public class AppEngineReducerContext extends Context {
    ...
    public final boolean nextKey() throws IOException, InterruptedException {
      throw new UnsupportedOperationException("nextKey() is not supported, control flow is externally controlled, sorry");
    }
  }
  ...
  static AppEngineReducer.AppEngineReducerContext getReducerContext(
      ...
      JobContext context,
      RecordWriter recordWriter, OutputCommitter outputCommitter, Configuration configuration, TaskAttemptID taskAttemptID) throws IOException, InterruptedException {
    ...
    try {
      ...
      return
          contextConstructor.newInstance(
              ...
              null, /* StatusReporter */
              null, /* RawComparator */
              LongWritable.class, /* This will fail if the class is not an instance of Writable.class */
